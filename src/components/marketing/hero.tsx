...
export function Hero() {
  return (
    <section className="marketing-hero-stage story-notebook-canvas relative overflow-hidden border-b border-black/10 dark:border-white/10">
      ...
      />
      <div className="relative z-10 mx-auto grid min-h-[calc(100svh-4rem)] w-full max-w-7xl items-center gap-14 px-6 py-16 lg:grid-cols-12 lg:gap-10 lg:px-8 lg:py-20">
        <div className="lg:col-span-6 lg:pr-8">
          <h1 className="max-w-3xl font-display text-[clamp(2.8rem,6.4vw,5.6rem)] font-semibold leading-[0.92] tracking-[-0.045em] text-balance">
