        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-xl shadow-2xl p-8 border border-gray-200">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={isLoading}
              className="w-full bg-white hover:bg-gray-100 disabled:bg-gray-50 disabled:cursor-not-allowed text-gray-800 font-semibold py-3 px-4 rounded-lg shadow-lg transition-all duration-200 flex items-center justify-center space-x-3"
            >
              {isLoading ? (
                <>
